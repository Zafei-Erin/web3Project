    ...
    <div className="border-b bg-white">
      <header className="h-14 items-center flex justify-between gap-3 px-6 xl:max-w-[90%] mx-auto">
        <div className="flex items-center gap-1 py-2">
          <Link to={"/"}>
            <LightLogo className="w-6 h-6 text-sky-950 hover:text-amber-400 transition" />
          </Link>
          {/* <Link to={"/swap"}>
          ...
          <Link to={"/explorer"}>
            <div className="text-xl font-medium text-sky-950 py-2 transition items-center hover:cursor-pointer">
              Explorer
            </div>
          </Link>
        </div>
