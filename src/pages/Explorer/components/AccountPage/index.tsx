...
export const AccountPage = () => {
  ...
  const tabList = tabs.map(({ type, title }, index) => (
    <button
      ...
      className={`text-xs font-semibold p-2 rounded-xl transition ${
        selectedTab === type
  ...
  return (
    <div className="w-full bg-gray-100 border-t">
      <div className="px-3 sm:px-4 py-2 2xl:max-w-[80%] mx-auto space-y-3">
        {/* header */}
        <div className="max-sm:space-y-2 sm:flex border-b pb-6 sm:items-center sm:justify-start sm:gap-2">
